...
export const LoveTimer = () => {
    ...
    return (
        <div className="absolute top-0 right-0 w-full md:w-auto p-6 flex justify-end z-20 pointer-events-none">
            <div className="bg-white/80 backdrop-blur-sm px-6 py-3 rounded-2xl shadow-lg border border-accent-pink/20 flex items-center gap-3">
                <Clock className="text-accent-pink animate-pulse" size={18} />
